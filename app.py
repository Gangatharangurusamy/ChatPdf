...
file_path="Asura by Anand Neelkanthan.pdf"
...
system_prompt = (
    ...
    "the question. If the question is from the context then answer from the context only which provided."
...
if user_input:
    ...
    # Add a time limit of 30 seconds
    import time
